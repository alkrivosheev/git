...
> 	-Merge commit  создает отдельный коммит слияния
> 	-Squash and merge объединяет все коммиты фичи в один коммит в main
> 	-Rebase and merge перебазирует коммиты фичи на main
> 	После слияния удалить ветку фичи
